...
class Generator {
    ...
    static Collection<RuchA> generuj_posunieciaA(SzachowaArena.figury[][] ust, boolean tura_rywala, boolean przelotcan,
            boolean blackleft, boolean blackright, boolean whiteleft, boolean whiteright,
            boolean kingrochB, boolean kingrochC, int sposob, int kolumna, boolean konkret, char znak_start, int[] start, boolean all) {
        List<RuchA> lista_dopuszcalnych_Ruchów = new ArrayList<>();
                ...
                switch (znak) {
                        ...
                        if (tura_rywala != false) {
                            if (x == 4 && przelotcan == true && kolumna != 0 && (kolumna - 1 == y - 1 || kolumna - 1 == y + 1)) {
                                ...
                                if (wynik == true || all == true) {
                                    ...
                                    if (!konkret || (konkret && x == start[0] && y == start[1])) {
                                        if (szach == false) {
                                            lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "x" + y1 + y2 + "EP "), sposob, SzachowaArena.figury.CPion, backup));
                                        } else {
                                            lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "x" + y1 + y2 + "EP+"), sposob, SzachowaArena.figury.CPion, backup));
                                        }
                                    }
                                    ...
                                    if (b != 0 && ((backup[x + 1][y + b] == SzachowaArena.figury.CSkoczek)
                                        ...
                                        if (x != 6) {
                                            ...
                                            if (wynik == true || all == true) {
                                                ...
                                                if (!konkret || (konkret && x == start[0] && y == start[1])) {
                                                    if (szach == true) {
                                                        lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "x" + y1 + y2 + "--+"), sposob, przechowalnie, backup));
                                                    } else {
                                                        lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "x" + y1 + y2 + "-- "), sposob, przechowalnie, backup));
                                                    }
                                                }
                                            ...
                                            for (int s = 0; s < 4; s++) {
                                                ...
                                                if (wynik == true || all == true) {
                                                    ...
                                                    if (!konkret || (konkret && x == start[0] && y == start[1])) {
                                                        if (szach == true) {
                                                            lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "x" + y1 + y2 + "=" + pozyskaj_symbol(symbole[s]) + "+"), sposob, przechowalnie, backup));
                                                        } else {
                                                            lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "x" + y1 + y2 + "=" + pozyskaj_symbol(symbole[s]) + " "), sposob, przechowalnie, backup));
                                                        }
                                                    }
                                ...
                                if (backup[x + 1][y] == SzachowaArena.figury.pustka || (backup[x + 1][y] != SzachowaArena.figury.CPion && backup[x + 1][y] != SzachowaArena.figury.BPion
                                    ...
                                    if (x != 6) {
                                        ...
                                        if (wynik == true || all == true) {
                                            ...
                                            if (!konkret || (konkret && x == start[0] && y == start[1])) {
                                                if (szach == true) {
                                                    lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "-" + y1 + y2 + "--+"), sposob, SzachowaArena.figury.pustka, backup));
                                                } else {
                                                    lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "-" + y1 + y2 + "-- "), sposob, SzachowaArena.figury.pustka, backup));
                                                }
                                            }
                                        ...
                                        for (int s = 0; s < 4; s++) {
                                            ...
                                            if (wynik == true || all == true) {
                                                ...
                                                if (!konkret || (konkret && x == start[0] && y == start[1])) {
                                                    if (szach == true) {
                                                        lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "-" + y1 + y2 + "=" + pozyskaj_symbol(symbole[s]) + "+"), sposob, SzachowaArena.figury.pustka, backup));
                                                    } else {
                                                        lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "-" + y1 + y2 + "=" + pozyskaj_symbol(symbole[s]) + " "), sposob, SzachowaArena.figury.pustka, backup));
                                                    }
                                                }
                    ...
                    case CAmazonka:
                       ...
                       if ((tura_rywala != false && znak == SzachowaArena.figury.BAmazonka) || (tura_rywala == false && znak == SzachowaArena.figury.CAmazonka)) {
                            ...
                            while (d1 == true || d2 == true || d3 == true || d4 == true
                                    || w1 == true || w2 == true || w3 == true || w4 == true) {
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BAmazonka) || (tura_rywala == false && znak == SzachowaArena.figury.CAmazonka)) {
                                    if (x + param_ruch < 8 && y + param_ruch < 8 && d1 == true) {

                                        if (d1 == true && backup[x + param_ruch][y + param_ruch] == SzachowaArena.figury.pustka) {
                                            backup[x + param_ruch][y + param_ruch] = znak;
                                            backup[x][y] = SzachowaArena.figury.pustka;
                                            ...
                                            if ((znak == SzachowaArena.figury.BAmazonka && (backup[x + param_ruch][y + param_ruch] == SzachowaArena.figury.CPion || backup[x + param_ruch][y + param_ruch] == SzachowaArena.figury.CSkoczek
                                                ...
                                                if (wynik == true || all == true) {
                                                    ...
                                                    if (!konkret || (konkret && ((x == start[0] && y == start[1])))) {
                                                        if (szach == true) {
                                                            lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + "" + x2 + "x" + y1 + "" + y2 + "--+"), sposob, przechowalnia, backup));
                                                        } else {
                                                            lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + "" + x2 + "x" + y1 + "" + y2 + "-- "), sposob, przechowalnia, backup));
                                                        }
                                                    }
                                ...
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BAmazonka) || (tura_rywala == false && znak == SzachowaArena.figury.CAmazonka)) {
                                    if (x - param_ruch > -1 && y - param_ruch > -1 && d2 == true) {
                                        ...
                                        if (d2 == true && backup[x - param_ruch][y - param_ruch] == SzachowaArena.figury.pustka) {
                                            backup[x - param_ruch][y - param_ruch] = znak;
                                            backup[x][y] = SzachowaArena.figury.pustka;
                                ...
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BAmazonka) || (tura_rywala == false && znak == SzachowaArena.figury.CAmazonka)) {
                                    if (x + param_ruch < 8 && y - param_ruch > -1 && d3 == true) {
                                        ...
                                        if (d3 == true && backup[x + param_ruch][y - param_ruch] == SzachowaArena.figury.pustka) {
                                            backup[x + param_ruch][y - param_ruch] = znak;
                                            backup[x][y] = SzachowaArena.figury.pustka;
                                            if ((obecnosc(backup) == true)) {
                                                wynik = (all == true || RuchZagrozenie_kontrola.szach(konwert(backup), tura_rywala) == false);
                                ...
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BAmazonka) || (tura_rywala == false && znak == SzachowaArena.figury.CAmazonka)) {
                                    if (x - param_ruch > -1 && y + param_ruch < 8 && d4 == true) {
                                        ...
                                        if (d4 == true && backup[x - param_ruch][y + param_ruch] == SzachowaArena.figury.pustka) {
                                            backup[x - param_ruch][y + param_ruch] = znak;
                                            backup[x][y] = SzachowaArena.figury.pustka;
                                ...
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BAmazonka) || (tura_rywala == false && znak == SzachowaArena.figury.CAmazonka)) {
                                    if (x + param_ruch < 8 && w1 == true) {
                                        ...
                                        if (w1 == true && backup[x + param_ruch][y] == SzachowaArena.figury.pustka) {
                                            backup[x + param_ruch][y] = znak;
                                            backup[x][y] = SzachowaArena.figury.pustka;
                                ...
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BAmazonka) || (tura_rywala == false && znak == SzachowaArena.figury.CAmazonka)) {
                                    if (x - param_ruch > -1 && w2 == true) {
                                        ...
                                        if (w2 == true && backup[x - param_ruch][y] == SzachowaArena.figury.pustka) {
                                            backup[x - param_ruch][y] = znak;
                                            backup[x][y] = SzachowaArena.figury.pustka;
                                ...
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BAmazonka) || (tura_rywala == false && znak == SzachowaArena.figury.CAmazonka)) {
                                    if (y + param_ruch < 8 && w3 == true) {
                                        ...
                                        if (w3 == true && backup[x][y + param_ruch] == SzachowaArena.figury.pustka) {
                                            backup[x][y + param_ruch] = znak;
                                            backup[x][y] = SzachowaArena.figury.pustka;
                                            if ((obecnosc(backup) == true)) {
                                                wynik = (all == true || RuchZagrozenie_kontrola.szach(konwert(backup), tura_rywala) == false);
                                ...
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BAmazonka) || (tura_rywala == false && znak == SzachowaArena.figury.CAmazonka)) {
                                    if (y - param_ruch > -1 && w4 == true) {
                                        ...
                                        if (w4 == true && backup[x][y - param_ruch] == SzachowaArena.figury.pustka) {
                                            backup[x][y - param_ruch] = znak;
                                            backup[x][y] = SzachowaArena.figury.pustka;
                                            if ((obecnosc(backup) == true)) {
                                                wynik = (all == true || RuchZagrozenie_kontrola.szach(konwert(backup), tura_rywala) == false);
                    ...
                    case BHetman:
                        ...
                        if ((tura_rywala != false && znak == SzachowaArena.figury.BHetman) || (tura_rywala == false && znak == SzachowaArena.figury.CHetman)) {
                            ...
                            while (d1 == true || d2 == true || d3 == true || d4 == true
                                    || w1 == true || w2 == true || w3 == true || w4 == true) {
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BHetman) || (tura_rywala == false && znak == SzachowaArena.figury.CHetman)) {
                                    if (x + param_ruch < 8 && y + param_ruch < 8 && d1 == true) {
                    ...
                    case CWieza:
                        if ((tura_rywala != false && znak == SzachowaArena.figury.BWieza) || (tura_rywala == false && znak == SzachowaArena.figury.CWieza)) {
                            ...
                            tyl = -1;
                            while (w1 == true || w2 == true || w3 == true || w4 == true) {
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BWieza) || (tura_rywala == false && znak == SzachowaArena.figury.CWieza)) {
                                    if (x + param_ruch < 8 && w1 == true) {
                    ...
                    case CGoniec:
                        if ((tura_rywala != false && znak == SzachowaArena.figury.BGoniec) || (tura_rywala == false && znak == SzachowaArena.figury.CGoniec)) {
                            ...
                            d4 = true;
                            while (d1 == true || d2 == true || d3 == true || d4 == true) {
                                if ((tura_rywala == true && znak == SzachowaArena.figury.BGoniec) || (tura_rywala == false && znak == SzachowaArena.figury.CGoniec)) {
                                    if (x + param_ruch < 8 && y + param_ruch < 8 && d1 == true) {
                        ...
                        if (tura_rywala == false) {
                            if (x == 3 && przelotcan == true && kolumna != 0 && (kolumna - 1 == y - 1 || kolumna - 1 == y + 1)) {
                                ...
                                if (wynik == true || all == true) {
                                    ...
                                    if (!konkret || (konkret && x == start[0] && y == start[1])) {
                                        if (szach == false) {
                                            lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "x" + y1 + y2 + "EP "), sposob, SzachowaArena.figury.BPion, backup));
                                        } else {
                                            lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + x2 + "x" + y1 + y2 + "EP+"), sposob, SzachowaArena.figury.BPion, backup));
                                        }
                                    }
                    ...
                    case BKrol:
                        if (tura_rywala != false) {
                                            ...
                                            if (backup[x + i][y + j] == SzachowaArena.figury.pustka
                                                ...
                                                if (wynik == true || all == true) {
                                                    ...
                                                    if (przech == SzachowaArena.figury.pustka) {
                                                        ...
                                                        if (!konkret || (konkret && x == start[0] && y == start[1])) {
                                                            if (szach == true) {
                                                                lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + "" + x2 + "x" + y1 + "" + y2 + "--+"), sposob, przech, backup));
                                                            } else {
                                                                lista_dopuszcalnych_Ruchów.add(new RuchA((pozyskaj_symbol(znak) + "" + x1 + "" + x2 + "x" + y1 + "" + y2 + "-- "), sposob, przech, backup));
                                                            }
                                                        }
                            ...
                            if (kingrochB == true) {
                                if (whiteright == true && (backup[0][5] == SzachowaArena.figury.pustka)
                                    ...
                                    if (wyniki[0] == true && wyniki[1] == true) {
                                        ...
                                        if (!konkret || (konkret && x == start[0] && y == start[1])) {
                                            if (szach == true) {
                                                lista_dopuszcalnych_Ruchów.add(new RuchA(("KO-O+   "), sposob, SzachowaArena.figury.pustka, backup));
                                            } else {
                                                lista_dopuszcalnych_Ruchów.add(new RuchA(("KO-O    "), sposob, SzachowaArena.figury.pustka, backup));
                                            }
                                        }
                                ...
                                if (whiteleft == true && (backup[0][3] == SzachowaArena.figury.pustka)
                                    ...
                                    if (wyniki[0] == true && wyniki[1] == true) {
                                        ...
                                        if (!konkret || (konkret && x == start[0] && y == start[1])) {
                                            if (szach == true) {
                                                lista_dopuszcalnych_Ruchów.add(new RuchA(("KO-O-O+  "), sposob, SzachowaArena.figury.pustka, backup));
                                            } else {
                                                lista_dopuszcalnych_Ruchów.add(new RuchA(("KO-O-O   "), sposob, SzachowaArena.figury.pustka, backup));
                                            }
                                        }
                    ...
                    case CKrol:
                        if (tura_rywala == false) {
                            ...
                            if (kingrochC == true) {
                                if (blackright == true && (backup[7][5] == SzachowaArena.figury.pustka)
                                ...
                                if (blackleft == true && (backup[7][3] == SzachowaArena.figury.pustka)
